...
//        builder.append("&pageNo="+paramVo.getPageNo());
    ...
    private Query buildQueryDsl(SearchParamVo paramVo) {
        ...
        //4.4 attrValue聚合
        TermsAggregationBuilder attrValueAgg = AggregationBuilders.terms("attrValueAgg").field("attrs.attrsValue").size(100);
